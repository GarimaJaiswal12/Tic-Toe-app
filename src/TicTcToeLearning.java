...
public void run() {
try {
TicTcToeLearning window = new TicTcToeLearning();
...
xCount.setFont(new Font("Tahoma", Font.BOLD, 45));
xCount.setText("0");
...
oCount.setText("0");
oCount.setFont(new Font("Tahoma", Font.BOLD, 45));
